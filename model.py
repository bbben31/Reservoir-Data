...
class DailyReportModel:
    ...
    def find_by_device_id_and_date_range(self, device_ids, from_date, to_date):
        key = {
            'device_id': device_ids,
            '$and': [{'date': {'$gte': from_date}},
                     {'date': {'$lte': to_date}}]
        }
        return self.__find_multiple(key)
    ...
    def find_first_anomaly_by_date_range(self, device_ids, threshold, from_date, to_date):
        key = {'device_id': {
            '$in': device_ids
        }, 'max_value': {'$gte': threshold}, 'date': {'$gte': from_date}, 'date': {'$lte': to_date}}
